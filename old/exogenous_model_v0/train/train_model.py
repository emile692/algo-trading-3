"""exogenous_model_v0/train_and_test/train_model.py"""
import json
import os
import numpy as np
import pandas as pd
...
def train_and_save_model(seed: int, logger):
    ...
    df_train_path = os.path.join(project_root, 'exogenous_model_v0', 'dataset', 'splits', f'seed_{seed}',
                                 f'df_train_processed.csv')
    df_val_path = os.path.join(project_root, 'exogenous_model_v0', 'dataset', 'splits', f'seed_{seed}',
                               f'df_val_processed.csv')
    df_test_path = os.path.join(project_root, 'exogenous_model_v0', 'dataset', 'splits', f'seed_{seed}',
    ...
    for epoch in range(EPOCHS):
        ...
        if val_loss < best_val_loss:
            ...
            best_model_path = os.path.join(project_root, 'exogenous_model_v0', 'model', 'checkpoints',
    ...
    scaler_path = os.path.join(project_root, 'exogenous_model_v0', 'model', 'checkpoints', f'scaler_seed_{seed}.pkl')
